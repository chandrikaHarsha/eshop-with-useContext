...
function ProductDetails() {
  ...
  const [singleProductViews, setSingleProductViews] = useState([]);
  const [data,setData]=useState([]);
  // console.log(singleProduct);

  let { wishList, setWishList } = useContext(DataContext);
  let Product = () => {
    axios
      ...
      .then((result) => {
        ...
        setSingleProductViews(result.data.images);
        setData({
          Utitle:result.data.title,
          Uthumbnail:result.data.thumbnail,
          Uprice:result.data.price,
          Ucategory:result.data.category,
          Uqnty:1
        })
      })
      .catch((error) => {
            ...
            <div class="flex flex-col md:flex-row -mx-4">
              <div class="md:flex-1 px-4">
                ...
                <div className="grid grid-flow-col">
                  {singleProductViews.map((v, i) => {
                    return (
                      <div className="grid grid-flow-col">
                        <img
                          src={v}
                          alt="product views"
                          className="cursor-pointer object-contain shadow-md w-[200px] h-[200px]"
                          onMouseOver={() => setThumbnail(v)}
                        />
                      </div>
                    );
                  })}
              ...
              <div class="md:flex-1 px-4">
                ...
                <p class="text-gray-500">{singleProduct.description}</p>
                ...
                <div class="flex py-4 space-x-4">
                  ...
                  <Link to={"/wishlist"}>
                    <button
                      ...
                      onClick={() => setWishList([...wishList, data])}
                    >
                      Add to WishList
                    </button>
                  </Link>
